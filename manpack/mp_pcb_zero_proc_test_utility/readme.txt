...
KT-001-0180-00 Manpack Motherboard, Zeroise Processor Test Utility

===============================================================================

1 - Introduction

This tets utility is used for the testing the KT-000-0180-00 Manpack
...
- Connect the KT-000-0180-00 RCU EIA-422 interface to a test PC using an FTDI
...
#SHCI id str| Sets the hardware configuration information item id to str.  
			...
			|
$ADC		| Reads the I2C LTC2991 ADC channels and display the results, all  
