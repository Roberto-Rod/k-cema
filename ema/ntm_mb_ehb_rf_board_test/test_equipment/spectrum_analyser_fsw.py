...
class SpectrumAnalyserFSW:
            ...
            if res:
                ...
                try:
                    if self.initialise_device():
                        print("Found and initialised FSW Spectrum Analyser: {}".format(res))
                        return True
                    else:
                        self.resource = None
                except:
                    self.resource = None
        print("ERROR: did not find an FSW Spectrum Analyser")
        return False
    ...
    def set_dB_per_division(self, division_dB):
        # Need to multiply by 10 (number of divisions)
    ...
    def get_dB_per_division(self):
        # Need to divide by 10 (number of divisions)
...
if __name__ == "__main__":
    ...
    print("SpectrumAnalyserFSW Test:")
