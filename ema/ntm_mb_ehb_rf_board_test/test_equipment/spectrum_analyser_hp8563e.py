            ...
            if res:
                ...
                try:
                    if self.initialise_device():
                        print("Found and initialised HP8563E Spectrum Analyser: {}".format(res))
                        return True
                    else:
                        self.resource = None
                except:
                    self.resource = None
        print("ERROR: did not find an HP8563E Spectrum Analyser")
        return False
...
if __name__ == "__main__":
    ...
    print("SpectrumAnalyserHP8563E Test:")
    ...
    print("Set dB per division to 10.0 dB: ", end="", flush=True)
