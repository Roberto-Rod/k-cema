        ...
        for res in self.rm.list_resources():
            if res:
                ...
                if self.initialise_device():
                    print("Found and initialised HP83752A Signal Generator: {}".format(res))
                    return True
                else:
                    self.resource = None
        print("ERROR: did not find an HP83752A Signal Generator")
        return False
...
if __name__ == "__main__":
    ...
    print("SignalGeneratorHP83752A Test:")
    ...
    print("Set output power to -50.0 dBm: ", end="", flush=True)
    ...
    print("Set output power to -60.0 dBm: ", end="", flush=True)
