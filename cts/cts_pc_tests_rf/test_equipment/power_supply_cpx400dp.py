        ...
        for res in resources:
            ...
            if res.startswith("ASRL"):
                ...
                if self.initialise_device():
                    print("Found and initialised CPX400DP Power Supply: {}".format(res))
                    return True
                else:
                    self.resource = None
        print("ERROR: did not find a CPX400DP Power Supply")
        return False
...
if __name__ == "__main__":
    ...
    print("PowerSupplyCPX400DP Test:")
    if psu.find_and_initialise():
        ...
        print("Ch2 Enabled:             {}".format(psu.dc_is_enabled(2)))
        print("Ch1 Voltage Setting:     {} V".format(psu.get_voltage(1)))
        print("Ch2 Voltage Setting:     {} V".format(psu.get_voltage(2)))
        print("Ch1 Voltage Out:         {} V".format(psu.get_voltage_out(1)))
        print("Ch2 Voltage Out:         {} V".format(psu.get_voltage_out(2)))
        print("Ch1 Current Setting:     {} A".format(psu.get_current(1)))
        print("Ch2 Current Setting:     {} A".format(psu.get_current(2)))
        print("Ch1 Current Out:         {} A".format(psu.get_current_out(1)))
        print("Ch2 Current Out:         {} A".format(psu.get_current_out(2)))
        print("Ch1 Power Out:           {} W".format(psu.get_power_out(1)))
        print("Ch2 Power Out:           {} W".format(psu.get_power_out(2)))
        print("Ch1 Average Power Out:   {} W".format(psu.get_average_power_out(1)))
        print("Ch2 Average Power Out:   {} W".format(psu.get_average_power_out(2)))
        print("Ch1 OVP Setting:         {} V".format(psu.get_ovp(1)))
        print("Ch2 OVP Setting:         {} V".format(psu.get_ovp(2)))
        print("Ch1 OCP Setting:         {} V".format(psu.get_ocp(1)))
        print("Ch2 OCP Setting:         {} V".format(psu.get_ocp(2)))
