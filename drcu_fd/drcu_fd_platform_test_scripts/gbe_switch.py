#!/usr/bin/env python3
"""
Module for accessing VSC7512 GbE switch registers using the serial port.
"""
# -----------------------------------------------------------------------------
...
-t, --temp, Print junction temperatures
-v, --version, Print software version

ARGUMENTS -------------------------------------------------------------
-c, --com_port, Serial COM port
"""
...
def main(kw_args):
    ...
    if int(kw_args.port_stats) > 0:
        ...
        log.info("INFO - uPort {} Statistics:\n{}".format(u_port, json.dumps(gs.get_port_statistics(u_port).__dict__)))
    ...
    if kw_args.mac_addr_table:
        log.info("INFO - MAC Address Table:\n{}".format(json.dumps(gs.get_mac_addresses())))
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--mac_addr_table", action="store_true", help="Print the MAC Address table")
