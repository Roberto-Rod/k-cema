#!/usr/bin/env python3
"""
This module includes classes and functions to configure the KT-000-0198/0199-00
...
class Tamper:
    ...
    def reset(self):
        ...
        self.i2c.write_word(self.TAMPER2_REG_ADDRESS, 0x0000)
...
def main(inactive, disarm, arm, status, rtc_ticking, time_rtc, bit):
    ...
    if bit:
        ...
        # driving the tamper input OPEN-CIRCUIT (dardk condition) if the the tamper rod is present and the unit
