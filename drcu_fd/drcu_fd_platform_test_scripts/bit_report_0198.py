#!/usr/bin/env python3
"""
Built-in test reporting module, prints BIT information for all KT-000-0198-00
DRCU Motherboard BIT sensors connected to the SoC.
"""
# -----------------------------------------------------------------------------
...
# Our own imports ---------------------------------------------------
from built_in_test_0198 import BitChannel, BuiltInTest
...
def main():
    ...
    gs = SerialGbeSwitch("/dev/ttymxc2", 115200)
    log.info("{:<6.2f}\t: VSC7512 junction temperature (deg C)".format(gs.get_sw_junc_temp()))
